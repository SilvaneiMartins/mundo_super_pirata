...
from sprites import Sprite, AnimatedSprite, Spike, MovingSprite, Item, ParticleEffectSprinte
...
class Level:
    ...
    def setup(self, tmx_map, level_frames):
        ...
        for obj in tmx_map.get_layer_by_name('BG details'):
            if obj.name == 'static':
                ...
                AnimatedSprite(
                    (obj.x, obj.y), level_frames[obj.name], self.all_sprites, Z_LAYERS['bg tiles'])
                if obj.name == 'candle':
                    AnimatedSprite((obj.x, obj.y) + vector(-20, -20),
                                   level_frames['candle_light'], self.all_sprites, Z_LAYERS['bg tiles'])
        ...
        for obj in tmx_map.get_layer_by_name('Moving Objects'):
            if obj.name == 'spike':
                ...
                speed = obj.properties['speed']
                MovingSprite(frames, groups, start_pos, end_pos,
                             move_dir, speed, obj.properties['flip'])
    ...
    def pearl_collision(self):
        for sprite in self.collision_sprites:
            ...
            if sprite:
                ParticleEffectSprinte((sprite[0].rect.center),
                                      self.particle_frames, self.all_sprites)
