...
class Game:
    def __init__(self):
        ...
        self.tmx_overworld = load_pygame(
            join('src', 'data', 'overworld', 'overworld.tmx'))
    ...
    def import_assets(self):
        ...
        self.font = pygame.font.Font(
            join('src', 'graphics', 'ui', 'runescape_uf.ttf'), 40)
        ...
        self.overworld_frames = {
            'palms': import_folder('src', 'graphics', 'overworld', 'palm'),
            'water': import_folder('src', 'graphics', 'overworld', 'water'),
            'path': import_folder_dict('src', 'graphics', 'overworld', 'path'),
            'icon': import_sub_folders('src', 'graphics', 'overworld', 'icon'),
        }
